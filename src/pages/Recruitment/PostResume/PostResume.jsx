...
const ResumeForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/addhr_resume_upload', formData, {
            headers: {
    ...
    useEffect(() => {
        if (functionalArea) {
            fetch(`https://k21consulting.com/api/public/api/area_specialization_list/${functionalArea.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`https://k21consulting.com/api/public/api/state_list/${selectedCountry.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
    ...
    useEffect(() => {
        if (selectedState) {
            axios.get(`https://k21consulting.com/api/public/api/city_list/${selectedState.value}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            })
