...
function EditAssetsType() {
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get(`https://k21consulting.com/api/public/api/edit_asset_typelist/${id}`, {
                    headers: {
    ...
    const handleSave = (e) => {
        ...
        axios.put('https://k21consulting.com/api/public/api/update_asset_type', requestData, {
            headers: {
                'Content-Type': 'application/json',
