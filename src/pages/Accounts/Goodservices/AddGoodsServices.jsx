...
function AddGoodsServices() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/addgood_service', requestData, {
            headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_goodservice', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
