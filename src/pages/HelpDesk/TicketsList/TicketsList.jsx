...
function TicketsList() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_raiseticket_list', {
                method: 'POST',
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_raiseticket', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                                        ...
                                        return (
                                            <tr key={row.id}>
                                                ...
                                                <td className='no-print'>
                                                    {row.attachment !== '-' ?
                                                        <button className="btn-view" onClick={() => { window.open(`https://k21consulting.com/api/storage/app/${row.attachment}`, '_blank') }}>
