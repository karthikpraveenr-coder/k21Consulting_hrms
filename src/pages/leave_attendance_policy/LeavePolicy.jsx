...
function LeavePolicy() {
    ...
    useEffect(() => {
        ...
        axios.get('https://k21consulting.com/api/public/api/leave_type_list', {
            headers: {
    ...
    useEffect(() => {
        const apiUrl = `https://k21consulting.com/api/public/api/employee_dropdown_list/${formattedSelectedRole}`;
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/addleave_policy', requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`
            }
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_leavepolicy', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_leavepolicy', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
