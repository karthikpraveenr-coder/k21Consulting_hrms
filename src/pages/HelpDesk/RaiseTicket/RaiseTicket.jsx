...
const RaiseTicket = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/manual_raiseticket', formData, {
            headers: {
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get('https://k21consulting.com/api/public/api/ticket_id', {
                    headers: {
