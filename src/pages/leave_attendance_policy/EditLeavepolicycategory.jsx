...
function EditLeavepolicycategory() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_leavecategory`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_leavecategory/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
