...
function EditEmpLevelCat() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_emplevelcategory`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_emplevelcategory/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
