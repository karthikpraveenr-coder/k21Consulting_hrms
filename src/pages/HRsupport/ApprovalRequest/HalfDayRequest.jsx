...
function HalfDayRequest() { 
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://k21consulting.com/api/public/api/approval_halfday_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/hr_halfday_approvallist', {
                method: 'POST',
                headers: {
