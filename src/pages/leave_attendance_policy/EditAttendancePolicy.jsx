...
function EditAttendancePolicy() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://k21consulting.com/api/public/api/update_attendancepolicy', requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_attendancepolicy/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
