...
function PermissionRequest() { 
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://k21consulting.com/api/public/api/approval_permission_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/hr_permission_approvallist', {
                                    ...
                                    filteredleaveData.map((row, index) => {
                                        ...
                                        return (
                                            <tr key={row.id}>
                                                ...
                                                <td>{row.proof !== null ?
                                                    <button className="btn-view" onClick={() => { window.open(`https://k21consulting.com/api/storage/app/${row.proof}`, '_blank') }}>
