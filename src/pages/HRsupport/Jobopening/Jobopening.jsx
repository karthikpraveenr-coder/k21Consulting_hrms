...
const Jobopening = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://k21consulting.com/api/public/api/add_jobopening', formData, {
      headers: {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://k21consulting.com/api/public/api/jobopening_list', {
        headers: {
          'Authorization': `Bearer ${usertoken}`
        }
      });
