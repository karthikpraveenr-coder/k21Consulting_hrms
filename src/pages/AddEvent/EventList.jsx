...
export default function EventList() {
    ...
    const fetchTableData = async () => {
        ...
        const apiUrl = `https://k21consulting.com/api/public/api/view_event_list`;
        try {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_event', {
                    method: 'POST',
                    headers: {
    ...
    const handleActionAcceptandReject = async () => {
        try {
            ...
            const response = await fetch('https://k21consulting.com/api/public/api/approval_event', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${usertoken}`
    ...
    const handleShow = async (item, status) => {
        ...
        try {
            ...
            const response = await axios.get(`https://k21consulting.com/api/public/api/event_status_list/${item.id}/${status}`, {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
