...
function EditOverTimeType() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_ot_requesttype`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_ot_requesttype/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
