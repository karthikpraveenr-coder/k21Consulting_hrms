...
export default function SalesInvoice() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://k21consulting.com/api/public/api/editview_saleinvoice/${id}`, {
            headers: {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/update_saleinvoice', {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${usertoken}`
