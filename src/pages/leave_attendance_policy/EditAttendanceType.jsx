...
function EditAttendanceType() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_attendancetype`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_attendancetype/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
