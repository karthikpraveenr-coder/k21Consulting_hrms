...
export default function AddPurchaseInvoice() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/addpurchaseinvoice', {
                method: 'POST',
                headers: {
    ...
    //         fetch(`https://k21consulting.com/api/public/api/sales_hsn_sac/${descriptionalGoods.value}`, {
    //             headers: {
    //                 'Authorization': `Bearer ${usertoken}`
    //             }
    //         })
    ...
    useEffect(() => {
        items.forEach((item, index) => {
            if (item.descriptionalGoods) {
                fetch(`https://k21consulting.com/api/public/api/sales_hsn_sac/${item.descriptionalGoods.value}`, {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`
                    }
                })
