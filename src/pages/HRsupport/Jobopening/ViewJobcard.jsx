...
function ViewJobcard() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://k21consulting.com/api/public/api/edit_jobopening_list/${id}`, {
                    headers: {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (reason) {
                const response = await axios.post('https://k21consulting.com/api/public/api/delete_job_opening', {
                    id: id,
