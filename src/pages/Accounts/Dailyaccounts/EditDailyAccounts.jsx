...
function EditDailyAccounts() {
    ...
    const handleSave = (e) => {
        ...
        axios.post(`https://k21consulting.com/api/public/api/updatedailyaccounts`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_dailyaccounts/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
