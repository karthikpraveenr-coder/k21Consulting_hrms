...
const EditCompany = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_company_information`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_company_information/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
