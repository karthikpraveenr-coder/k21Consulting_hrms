...
function Attendancelocation() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/employeeshiftinsert', requestData, {
            headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_employeeshift', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_employeeshift', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
