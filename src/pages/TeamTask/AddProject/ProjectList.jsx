...
function ProjectList() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_project_list', {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_project', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
