...
function AdminAssignedTaskList() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_assigntask_list', {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_task', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const applyFilter = async (e) => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/filter_tasklist', {
                method: 'POST',
                body: formData,
                headers: {
                    'Authorization': `Bearer ${usertoken}`
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const apiUrl = `https://k21consulting.com/api/public/api/employee_dropdown_list/${formattedSelectedDepartment}`;
            try {
    ...
    const handleModalSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/task_update_status', {
                method: 'PUT',
                                        ...
                                        return (
                                            <tr key={row.id}>
                                                ...
                                                <td className='no-print'>{row.attachment !== null ?
                                                    <button style={{ padding: '6px' }} className="btn-view" onClick={() => { window.open(`https://k21consulting.com/api/storage/app/${row.attachment}`, '_blank') }}>
