...
const EditJob = () => {
    ...
    useEffect(() => {
        const fetchJobDetails = async () => {
            try {
                const response = await axios.get(`https://k21consulting.com/api/public/api/post_job_editlist/${id}`, {
                    headers: {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('https://k21consulting.com/api/public/api/update_post_job', postData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
