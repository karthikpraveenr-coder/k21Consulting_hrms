...
function EditGoodsServices() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_goodservice`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_goodservice/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
