...
function EditAttendancelocation() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_attendancelocation`, requestData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/editview_attendancelocation/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
