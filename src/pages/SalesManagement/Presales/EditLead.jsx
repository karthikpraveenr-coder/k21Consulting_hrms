...
const EditLead = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/editpresale_leadlist', formData, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    //         try {
    //             const response = await axios.get('https://k21consulting.com/api/public/api/getautogenerateLeadId', {
    //                 headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/viewedit_leadlist/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        if (department) {
            const apiUrl = `https://k21consulting.com/api/public/api/employee_dropdown_list/${department}`;
                            ...
                            <Form.Group controlId="preferredLocation">
                                {consultDocument !== '-' && (
                                    <>
                                        ...
                                        <button style={{}} className="btn-view" onClick={() => { window.open(`https://k21consulting.com/api/storage/app/${consultDocument}`, '_blank') }}>
