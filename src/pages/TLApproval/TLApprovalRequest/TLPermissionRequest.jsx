...
function TLPermissionRequest() {
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://k21consulting.com/api/public/api/tl_approval_permission_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/tl_permissionrequest_list', {
