...
function TLHalfDayRequest() {
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://k21consulting.com/api/public/api/tl_approval_halfday_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/tl_halfdayrequest_list', {
                method: 'POST',
                headers: {
