...
function LeavePolicy() {
    ...
    const handleSave = (e) => {
        ...
        axios.put(`https://k21consulting.com/api/public/api/update_leavepolicy`, requestData, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${usertoken}`
            }
    ...
    useEffect(() => {
        ...
        axios.get(`https://k21consulting.com/api/public/api/editview_leavepolicy/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
