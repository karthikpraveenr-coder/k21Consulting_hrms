...
function RoleList() {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_addrole', {
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_role', {
                    method: 'POST',
                    headers: {
