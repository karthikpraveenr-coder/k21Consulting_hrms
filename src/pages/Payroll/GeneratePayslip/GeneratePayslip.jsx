...
const GeneratePayslip = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/add_generate_payslip', formData, {
            headers: {
    ...
    useEffect(() => {
        if (month && selectedEmployee) {
            ...
            axios.post('https://k21consulting.com/api/public/api/get_emp_yearmonth_details', {
    ...
    useEffect(() => {
        if (month && selectedEmployee && lossOfPay) {
            ...
            axios.post('https://k21consulting.com/api/public/api/ot_emp_salary_details', {
                emp_id: selectedEmployee,
                yearmonth: yearMonth,
                lop: lossOfPay,
            }, {
