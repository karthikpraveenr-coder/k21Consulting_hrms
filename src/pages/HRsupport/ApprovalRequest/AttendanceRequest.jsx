...
function AttendanceRequest() {
    ...
    const handleStatusButtonClick = (row, status) => {
        ...
        fetch('https://k21consulting.com/api/public/api/approval_attendance_request', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/hr_attendance_approvallist', {
