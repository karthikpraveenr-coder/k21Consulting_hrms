...
export default function EditRelievingLetter() {
    ...
    const handleSave = async (e) => {
        ...
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/update_relieving_letter', {
                method: 'POST',
                body: formData,
                headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/edit_relieving_list/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
