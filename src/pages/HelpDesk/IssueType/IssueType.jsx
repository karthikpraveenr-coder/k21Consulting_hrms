...
function IssueType() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/add_issue_type', requestData, {
            headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://k21consulting.com/api/public/api/view_issuetype', {
                headers: {
                    'Authorization': `Bearer ${usertoken}`
                }
            });
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (reason) {
                const response = await fetch('https://k21consulting.com/api/public/api/delete_issuetype', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
