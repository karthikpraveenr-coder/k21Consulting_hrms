...
const EditTaskList = () => {
    ...
    const handleSave = (e) => {
        ...
        axios.post('https://k21consulting.com/api/public/api/update_task_list', formData, {
            headers: {
    ...
    useEffect(() => {
        axios.get(`https://k21consulting.com/api/public/api/edit_tasklist/${id}`, {
            headers: {
                'Authorization': `Bearer ${usertoken}`
            }
        })
    ...
    useEffect(() => {
        const fetchAssetId = async () => {
            try {
                const response = await axios.get('https://k21consulting.com/api/public/api/task_id', {
                    headers: {
    ...
    useEffect(() => {
        const fetchProjectNames = async () => {
            try {
                const response = await axios.get('https://k21consulting.com/api/public/api/project_name_list', {
                    headers: {
                        'Authorization': `Bearer ${usertoken}`
                    }
                });
